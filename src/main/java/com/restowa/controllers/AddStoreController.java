...
public class AddStoreController {
    ...
    public ModelAndView store() {
        ModelAndView model = new ModelAndView("addStore");
    ...
    public String addStore(@Valid Store store, BindingResult storeResult, @Valid Schedule schedule, BindingResult scheduleResult, @Valid Address address, BindingResult addressResult, Model model) {
